export const menuSections = [
  {
    ...
    items: [
      ...
      },
      {
        id: "chn7",
        name: "Hot Pot (火锅)",
        description: "A bubbling pot of broth with assorted meats, seafood, and vegetables for dipping.",
        price: "$28",
        tags: ["gluten-free", "nut-free"]
      }
    ]
    ...
    items: [
      {
        id: "chn5",
        name: "Char Siu (叉烧)",
        description: "Cantonese-style barbecued pork with a sweet, savory glaze.",
        price: "$11",
        tags: ["nut-free", "gluten-free"]
      },
      {
        id: "chn6",
        name: "Sweet and Sour Pork (咕噜肉)",
      ...
      },
      {
        ...
        description: "Stir-fried chicken with peanuts, dried chilies, and a sweet-spicy sauce.",
        price: "$13",
        tags: ["spicy"]
      },
      {
        id: "chn3",
        name: "Mapo Tofu (麻婆豆腐)",
        description: "Silky tofu in a spicy, numbing Sichuan pepper sauce with minced pork.",
        price: "$12",
      ...
      },
      {
        ...
        description: "Pork belly slices stir-fried with leeks and spicy bean paste.",
        price: "$13",
        tags: ["spicy", "nut-free"]
      },
      {
        id: "chn12",
        name: "Lion's Head Meatballs (狮子头)",
        description: "Large, tender pork meatballs braised in a savory sauce.",
        price: "$14",
        tags: ["nut-free"]
      },
      {
        ...
        description: "Stir-fried wide rice noodles with beef, bean sprouts, and soy sauce.",
        price: "$12",
        tags: ["nut-free"]
      },
      {
        id: "chn15",
        name: "Salt and Pepper Shrimp (椒盐虾)",
        description: "Crispy shrimp tossed with salt, pepper, and fresh chilies.",
        price: "$16",
        tags: ["spicy", "gluten-free", "nut-free"]
      },
      {
        id: "chn11",
        name: "Steamed Fish with Ginger and Scallion (清蒸鱼)",
        description: "Whole fish steamed with ginger, scallions, and soy sauce.",
        price: "$22",
        tags: ["gluten-free", "nut-free"]
      },
      {
        id: "chn19",
        name: "Lotus Leaf Sticky Rice (荷叶饭)",
        description: "Sticky rice with chicken, mushrooms, and sausage, steamed in a lotus leaf.",
        price: "$11",
        tags: ["gluten-free", "nut-free"]
      },
      {
        ...
        description: "Crispy rolls filled with vegetables and pork, served with dipping sauce.",
        price: "$6",
      ...
      },
      {
        ...
        description: "Steamed soup dumplings filled with juicy pork and rich broth.",
        price: "$8",
        tags: ["nut-free"]
      }
    ]
    ...
    items: [
      {
        ...
        description: "Spicy Sichuan noodles with minced pork and pickled vegetables.",
        price: "$10",
        tags: ["spicy", "nut-free"]
      },
      {
        id: "chn10",
        name: "Sichuan Spicy Noodles (四川担担面)",
        description: "Noodles tossed in a spicy, numbing Sichuan sauce with minced pork.",
        price: "$10",
        tags: ["spicy", "nut-free"]
      },
      {
        id: "chn16",
        name: "Century Egg and Pork Congee (皮蛋瘦肉粥)",
        description: "Rice porridge with preserved egg and tender pork.",
        price: "$8",
        tags: ["gluten-free", "nut-free"]
      },
      {
        ...
        description: "Classic fried rice with egg, scallions, and a touch of soy sauce.",
        price: "$7",
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "chn20",
        name: "Red Bean Buns (豆沙包)",
        description: "Steamed buns filled with sweet red bean paste.",
        price: "$6",
        tags: ["vegan", "vegetarian", "nut-free"]
      }
    ]
  },
  {
